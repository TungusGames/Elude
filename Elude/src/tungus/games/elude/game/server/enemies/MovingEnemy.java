...
public class MovingEnemy extends Enemy {
	...
	public MovingEnemy(Vector2 pos, World w) {
		this(pos, EnemyType.MOVING, w, Assets.movingEnemyBlue, RocketType.SLOW_TURNING, SPEED, RELOAD, new float[]{0.1f,1,1,1});
	}
	
	public MovingEnemy(Vector2 pos, EnemyType t, World w, TextureRegion tex, RocketType type, float speed, float reload, float[] color) {
