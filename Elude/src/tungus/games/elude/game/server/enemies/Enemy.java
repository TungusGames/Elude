...
public abstract class Enemy extends Updatable implements Hittable {
	...
	public static enum EnemyType {
		...
		CLOSING_BOSS (Assets.Tex.BOSS1,			2.0f,	2.8f,	new float[]{0.9f, 0.4f, 0.1f, 1f}, 	false, 	ClosingBoss.class, 		70),
		BOSS_TELEPORT(Assets.Tex.BOSS2,			1.5f,	2.1f,	new float[]{0.8f, 0.3f, 0.7f, 1f}, 	false, 	TeleportingBoss.class,	50);
		public Tex tex;
		public float width;
