...
public class OneDeadTwoCome extends ArcadeLoaderBase {
	...
	public OneDeadTwoCome(World w, int levelNum) {
		...
		world.addEnemy(Enemy.fromType(world, EnemyType.STANDING));
	}
	
	@Override
	public void onEnemyDead(Enemy e) {
		super.onEnemyDead(e);
		world.addEnemy(Enemy.fromType(world, EnemyType.MOVING));
		world.addEnemy(Enemy.fromType(world, MathUtils.randomBoolean() ? EnemyType.KAMIKAZE : EnemyType.STANDING));
	}
